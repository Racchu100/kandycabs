          ...
          if (vehicle) {
            const dbBooking = await prisma.booking.create({
              data: {
                ...
                pickupLat: body.pickupLatitude ? Number(body.pickupLatitude) : 12.9716,
                pickupLng: body.pickupLongitude ? Number(body.pickupLongitude) : 77.5946,
                dropAddress: body.dropAddress || body.drop || 'Drop Location',
                dropLat: body.dropLatitude ? Number(body.dropLatitude) : 12.2958,
                dropLng: body.dropLongitude ? Number(body.dropLongitude) : 76.6394,
